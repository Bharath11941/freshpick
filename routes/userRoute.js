...
userRoute.post('/otp',userController.verifyMail)
...
userRoute.post('/updateProfile',userSession.isLogin,userController.updateProfile)
userRoute.get('/address',userSession.isLogin,userController.addressForm)
userRoute.post('/address',userSession.isLogin,userController.addAddress)
userRoute.post('/updateAddress',userSession.isLogin,userController.updateAddress)
...
userRoute.post('/resetPassword',userController.postResetPassword)
userRoute.get('/forgetPassword',userSession.isLogout,userController.forgetPasswordLoad)
userRoute.post('/forgetPassword',userSession.isLogout,userController.postForgetPassword)
userRoute.post('/newPassword',userSession.isLogout,userController.newPassword)
...
userRoute.post('/applyCoupon',userSession.isLogin,orderController.applyCoupon)
...
// userRoute.get('/invoice/:orderId',userSession.isLogin,userController.downloadInvoice)
